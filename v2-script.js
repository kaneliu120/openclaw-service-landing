const translations = {
    en: {
        ...
        who_text: "Most people struggle with the technical installation or API configurations. I'm offering a done-for-you on-site service to get you up and running on your own hardware.",
    ...
    cn: {
        ...
        cta: "预约服务",
        who_title: "服务内容",
        who_text: "很多人卡在复杂的 GitHub 配置或 API 申请上。我提供一站式上门技术服务，帮您搞定一切。",
        req_title: "设备要求",
    ...
    tl: {
        ...
        cta: "Book Now",
        who_title: "The Service",
        who_text: "Alám ko, medyo hassle i-install kung hindi ka techie. Kaya nag-o-offer ako ng done-for-you on-site service. Pupuntahan kita para i-setup 'to.",
        req_title: "Requirements",
